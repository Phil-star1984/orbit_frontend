 ...
 return setCount(count+1)
  ...
  return (
    ...
    <CategoryButtons />
      ...
      {/* PREVIOUS BUTTON */}
    <button onClick={handlePrevious} disabled={count===1?true:false} className= "inline-flex items-center px-5 py-1.5 rounded-full text-sm font-medium text-center text-white  hover:text-pink hover:scale-125 focus:outline-none disabled:scale-100 disabled:text-gray-500 disabled:border-gray-600">
    ...
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#660099" className="w-6 h-6">
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#660099" className="w-6 h-6">
  <path fillRule="evenodd" d="M3.75 12a.75.75 0 01.75-.75h15a.75.75 0 010 1.5h-15a.75.75 0 01-.75-.75z" clipRule="evenodd" />
    ...
    {/* NEXT BUTTON  */}
    <button onClick={handleNext} className="inline-flex items-center px-5 py-1.5 rounded-full text-sm font-medium text-center text-white  hover:text-pink hover:scale-125 focus:outline-none">
      Next
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
          ...
          data.results.map((game) => (
            ...
            <div className="p-5">
              ...
              <div className="flex flex-col mt-4 text-gray-500">
                ...
                <div>
                <p className="mt-1"> ESRB: {game.esrb_rating === null? " n/a": game.esrb_rating.name} </p>
                </div>

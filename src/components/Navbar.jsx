        ...
        <>
          <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
            <div className="pt-7 relative flex h-16 items-center justify-between">
              <div className="absolute inset-y-11 left-0 flex items-center sm:hidden">
                {/* Mobile menu button*/}
              ...
              <div className="absolute inset-y-11 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                <button
                  type="button"
                  className="hidden lg:block relative rounded-full bg-gray-800 p-1 text-gray-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800"
                >
                ...
                <Disclosure.Button
                  ...
                  className={classNames(
                    item.current
                      ...
                      : "text-gray-300 bg-black hover:bg-gray-700 hover:text-white",
